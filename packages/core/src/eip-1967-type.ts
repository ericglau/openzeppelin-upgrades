import { EIP1967BeaconNotFound, EIP1967ImplementationNotFound, getBeaconAddress, getImplementationAddress } from "./eip-1967";
import { EthereumProvider } from "./provider";

export async function isTransparentOrUUPSProxy(provider: EthereumProvider, proxyOrBeaconAddress: string): Promise<boolean> {
  try {
