...
const ERC1967Proxy = require('../artifacts/@openzeppelin/contracts-v4/proxy/ERC1967/ERC1967Proxy.sol/ERC1967Proxy.json');

const BeaconProxy = require('../artifacts/@openzeppelin/contracts-v4/proxy/beacon/BeaconProxy.sol/BeaconProxy.json');
const UpgradableBeacon = require('../artifacts/@openzeppelin/contracts-v4/proxy/beacon/UpgradeableBeacon.sol/UpgradeableBeacon.json');
